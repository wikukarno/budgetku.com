...
Route::prefix('/pages/customer')
    ...
    ->group(function () {
        ...
        Route::get('/income/edit/{uuid}', [UserIncomeController::class, 'edit'])->name('income.edit');
        ...
        Route::get('/expense/edit/{uuid}', [UserFinanceController::class, 'edit'])->name('expense.edit');
