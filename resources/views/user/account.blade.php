            ...
            <div class="card-body">
                ...
                <form action="{{ route('user.ubah.profile') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center thumbnail-image" onclick="updateImage()">
                        ...
                        @else
                        <img class="profile-user-img img-fluid img-circle" src="{{ asset('assets/images/faces/face1.jpg') }}"
                ...
                <form action="{{ route('akun.update', $user->id) }}" method="POST" id="update-akun">
                    @csrf
                    @method('PUT')
                    <div class="row">
