<template>
  <MainLayout title="Add Income" page-title="Add Income" :requireUnlock="true">
...
async function getDecPriv(){
  ...
  // Try R from store, then sessionStorage fallback
...
async function fetchCategories(){
  ...
  } catch {} finally { hidePreloader(); catLoading.value = false; }
}
...
async function onSubmit(){
  ...
  try {
    ...
    // Encrypt salary if possible (store armor + placeholder)
    ...
    await window.axios.post('/pages/customer/income/store', fd);
